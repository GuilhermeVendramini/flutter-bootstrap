...
```
Inside "**app/shared/utils/i18n/locales**" add your file "locale": Example:
...
The default theme is declared in "**app/core/themes/core.themes.default.dart**", here you can customized you theme. 
